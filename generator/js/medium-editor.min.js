    ...
    function(a, b) {
        ...
        MediumEditor.prototype = {
            ...
            bindTab: function(a) {
                return this.elements[a].addEventListener("keydown", function(a) {
                    if (9 === a.which) {
                        ...
                        "pre" === c && (a.preventDefault(), b.execCommand("insertHtml", null, "    ")), "li" === c && (a.preventDefault(), a.shiftKey ? b.execCommand("outdent", a) : b.execCommand("indent", a))
                    }
                }), this
            },
            ...
            checkSelection: function() {
                var b, c;
                return this.keepToolbarAlive === !0 || this.options.disableToolbar || (b = a.getSelection(), "" === b.toString().trim() || this.options.allowMultiParagraphSelection === !1 && this.hasMultiParagraphs() || this.selectionInContentEditableFalse() ? this.hideToolbarActions() : (c = this.getSelectionElement(), !c || c.getAttribute("data-disable-toolbar") ? this.hideToolbarActions() : this.checkSelectionElement(b, c))), this
            },
            ...
            findMatchingSelectionParent: function(b) {
                var c, d, e, f, g = a.getSelection(),
                    h = function(a) {
                        var c = a;
                        try {
                            for (; !b(c);) c = c.parentNode
                        } catch (d) {
                            return !1
                        }
                        return c
                ...
                try {
                    c = g.getRangeAt(0), d = c.commonAncestorContainer, e = d.parentNode, f = b(d) ? d : h(e)
                } catch (i) {
                    f = h(e)
                }
                return f
            ...
            saveSelection: function() {
                this.savedSelection = e()
            },
            restoreSelection: function() {
                f(this.savedSelection)
            },
            showAnchorForm: function(a) {
                this.toolbarActions.style.display = "none", this.saveSelection(), this.anchorForm.style.display = "block", this.setToolbarPosition(), this.keepToolbarAlive = !0, this.anchorInput.focus(), this.anchorInput.value = a || ""
            },
            bindAnchorForm: function() {
                var a = this.anchorForm.querySelector("a.medium-editor-toobar-anchor-close"),
                    c = this.anchorForm.querySelector("a.medium-editor-toobar-anchor-save"),
                    e = this;
                return this.anchorForm.addEventListener("click", function(a) {
                    a.stopPropagation(), e.keepToolbarAlive = !0
                }), this.anchorInput.addEventListener("keyup", function(a) {
                    var b, c = null;
                    13 === a.keyCode && (a.preventDefault(), b = e.options.anchorTarget && e.anchorTarget.checked ? "_blank" : "_self", e.options.anchorButton && e.anchorButton.checked && (c = e.options.anchorButtonClass), e.createLink(this, b, c))
                }), c.addEventListener("click", function(a) {
                    var b, c = null;
                    a.preventDefault(), b = e.options.anchorTarget && e.anchorTarget.checked ? "_blank" : "_self", e.options.anchorButton && e.anchorButton.checked && (c = e.options.anchorButtonClass), e.createLink(e.anchorInput, b, c)
                }, !0), this.anchorInput.addEventListener("click", function(a) {
                    a.stopPropagation(), e.keepToolbarAlive = !0
                }), b.body.addEventListener("click", function(a) {
                    a.target === e.anchorForm || d(e.anchorForm, a.target) || d(e.toolbarActions, a.target) || (e.keepToolbarAlive = !1, e.checkSelection())
                }, !0), b.body.addEventListener("focus", function(a) {
                    a.target === e.anchorForm || d(e.anchorForm, a.target) || d(e.toolbarActions, a.target) || (e.keepToolbarAlive = !1, e.checkSelection())
                }, !0), a.addEventListener("click", function(a) {
                    a.preventDefault(), e.showToolbarActions(), f(e.savedSelection)
                }), this
            },
            ...
            showAnchorPreview: function(b) {
                if (this.anchorPreview.classList.contains("medium-editor-anchor-preview-active") || b.getAttribute("data-disable-preview")) return !0;
                var c, d, e, f = this,
                    g = 40,
            ...
            setButtonClass: function(a) {
                var b, c, d = g(),
                    e = a.split(" ");
                if ("a" === d.tagName.toLowerCase())
                    for (c = 0; c < e.length; c += 1) d.classList.add(e[c]);
                else
                    for (d = d.getElementsByTagName("a"), b = 0; b < d.length; b += 1)
                        for (c = 0; c < e.length; c += 1) d[b].classList.add(e[c])
            },
            createLink: function(c, d, e) {
                var g, h;
                if (0 === c.value.trim().length) return void this.hideToolbarActions();
                if (f(this.savedSelection), this.options.checkLinkFormat && (c.value = this.checkLinkFormat(c.value)), b.execCommand("createLink", !1, c.value), (this.options.targetBlank || "_blank" === d) && this.setTargetBlank(), e && this.setButtonClass(e), this.options.targetBlank || "_blank" === d || e)
                    for (h = b.createEvent("HTMLEvents"), h.initEvent("input", !0, !0, a), g = 0; g < this.elements.length; g += 1) this.elements[g].dispatchEvent(h);
                this.checkSelection(), this.showToolbarActions(), c.value = ""
            },
